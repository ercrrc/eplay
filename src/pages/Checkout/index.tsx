        ...
        <Card title="Muito obrigado">
          <>
            <p>
              ...
              Forma de pagamento:{' '}
              {payWithCard ? 'Cartao de credito' : 'Boleto Bancário'}
            </p>
                ...
                {payWithCard ? (
                  <>
                    ...
                    <S.Row marginTop="24px">
                      ...
                      <S.InputGroup>
                        <label htmlFor="cardNumber">Numer do cartão</label>
                        <InputMask
                          type="text"
                          id="cardNumber"
                          name="cardNumber"
                    ...
                    <S.Row marginTop="24px">
                      <S.InputGroup maxWidth="150px">
                        ...
                        <select
                          ...
                          onBlur={form.handleBlur}
                          className={
                            checkInputHasError('instalments') ? 'error' : ''
                          }
                        >
                  ...
                  <p>
                    ...
                    Portanto, a liberação do do código de ativação do jogo
